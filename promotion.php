...
$products = getPromotionsProducts($conn, $currentPage, $productsPerPage);
$totalProducts = countDiscountedProducts($conn);
    ...
    <main>
        <?php if (empty($products)): ?>
            <div class="no-product">
                <h1>No products in promotion yet</h1>
            </div>
        <?php else: ?>
        ...
        <div class="pagination">
            ...
            <a href="promotion.php?page=<?= $currentPage - 1 ?>">
            ...
            for ($i = $startPage; $i <= $endPage; $i++): ?>
                <a href="promotion.php?page=<?= $i ?>"<?= $i === $currentPage ? 'class="active"' : '' ?>><?= $i ?></a>
            <?php endfor; ?>
