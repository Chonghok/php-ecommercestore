...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($email)) {
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT adminID FROM admin WHERE (username = :username OR email = :email) AND adminID != :adminID");
...
<body>
    ...
    <main class="update-admin">
        ...
        <form id="adminForm" method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?= htmlspecialchars($admin['username']) ?>" placeholder="Enter username" required />
            </div>
            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" value="<?= htmlspecialchars($admin['email']) ?>" placeholder="Enter email" required />
            </div>
            <div class="form-group">
    ...
    <div class="confirm-modal" id="confirmModal">
        <div class="confirm-content">
            <div class="confirm-message" id="confirmMessage">Are you sure you want to update this admin account?</div>
